...
<div id="page" class="site">
	...
	<section id="coming-soon-page">
      <div class="container">
        ...
        <h1>Coming Soon!</h1>
        <br>
        <h5>Very soon you will be able to purchase domains and web hosting from the Tiger Stripe Media website. I am very excited about this and can't wait to launch it.</h5>
        <br>
        <h5>Hayden Ingham</h5>
